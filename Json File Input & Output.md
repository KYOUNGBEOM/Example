...
public class JsonTest {
	...
	public static void main(String[] args) throws Exception {
		...
		BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("C://person.json")));
		gson.toJson(person1, bw);
		bw.close();
		
		// Q. person2.json에 저장된 내용을 읽어오도록 객체를 선언해 봅시다.
		BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("C://person.json")));
        ...
        br.close();
		Person person2 = gson.fromJson(jsonContent.toString(), Person.class);
